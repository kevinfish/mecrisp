...
; Main file for Mecrisp for MSP430G2553.
...
;------------------------------------------------------------------------------
  ...
  welcome " for MSP430G2553 Lowpower by Matthias Koch"
...
;------------------------------------------------------------------------------
 ...
 org 0FFE0h ; Interrupt table with hooks
  ...
  .word   irq_wecken_tx        ; 07: 0FFEC  USCI Transmit  - Terminal
  .word   irq_wecken_rx        ; 08: 0FFEE  USCI Receive   -   interrupts
