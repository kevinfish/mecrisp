...
; Main file for Mecrisp for MSP430G2955.
...
FlashAnfang equ 2100h ; Start of Flash, 56 kb, Flash end always is $FFFF.
...
;------------------------------------------------------------------------------
  ...
  welcome " for MSP430G2955 by Matthias Koch"
